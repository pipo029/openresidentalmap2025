...
if __name__ == "__main__":
    ...
    ownertype_path = data_root / 'feture_engineering' / 'census' / '6' / '第7表_住宅の所有関係別一般世帯数2020小地域集計.csv'
    ...
    usage_area_path = 'G:/マイドライブ/akiyamalab/オープン住宅地図/code_data/feture_engineering/nlfpt/6/用途地域/01-01_シェープファイル形式/A29-19_{target_area}.shp'
    # 建物データ（basemap）パス
