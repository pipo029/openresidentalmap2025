...
if __name__ == "__main__":
    ...
    # 特徴量作成クラスのパス
    age_group_path = data_root / 'EDA' / 'step3' / '国勢調査' / '第3表_年齢階級.csv'
    ownertype_path = data_root / 'EDA' / 'step3' / '国勢調査' / '第7表_住宅の所有関係別一般世帯数2020小地域集計.csv'
    year_income_path = data_root / 'EDA' / 'step3' / '住宅土地統計調査' / '第44-4表_世帯の年間収入階級.xlsx'
    length_residence_path = data_root / 'EDA' / 'step3' / '国勢調査' / '第18表_居住期間小地域集計2020.csv'
    ...
    how_to_build_path = data_root / 'EDA' / 'step3' / '国勢調査' / '第8表 _住宅の建て方別一般世帯数－町丁・字等2020.csv'
    # usage_area_path = 'G:/マイドライブ/akiyamalab/オープン住宅地図/code_data/EDA/step4/新潟県用途地域/A29-11_15.shp'
    poi_path = '//Akiyamalab_02/Akiyamalab02/科研費B/B_Building_Type_Clasification/data/raw/polygon/poi/15/{target_area}.parquet'
    # 建物データ（basemap）パス
